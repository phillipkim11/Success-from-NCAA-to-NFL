...
library(ggplot2)
library(readr)
college_stats <- read_csv("SDS 322E Project/college_stats.csv")
ncaa_schools <- read_csv("SDS 322E Project/ncaa_schools.csv")
wAV_leaders <- read_csv("SDS 322E Project/wAV_leaders.csv")
aaron_donald <- read_csv("SDS 322E Project/aaron_donald.csv")
aaron_rodgers <- read_csv("SDS 322E Project/aaron_rodgers.csv")
adrian_peterson <- read_csv("SDS 322E Project/adrian_peterson.csv")
aeneas_williams <- read_csv("SDS 322E Project/aeneas_williams.csv")
alan_faneca <- read_csv("SDS 322E Project/alan_faneca.csv")
alan_page <- read_csv("SDS 322E Project/alan_page.csv")
alex_karras <- read_csv("SDS 322E Project/alex_karras.csv")
alex_smith <- read_csv("SDS 322E Project/alex_smith.csv")
andre_johnson <- read_csv("SDS 322E Project/andre_johnson.csv")
andre_reed <- read_csv("SDS 322E Project/andre_reed.csv")
andrew_whitworth <- read_csv("SDS 322E Project/andrew_whitworth.csv")
anthony_munoz <- read_csv("SDS 322E Project/anthony_munoz.csv")
antonio_brown <- read_csv("SDS 322E Project/antonio_brown.csv")
antonio_gates <- read_csv("SDS 322E Project/antonio_gates.csv")
art_shell <- read_csv("SDS 322E Project/art_shell.csv")
barry_sanders <- read_csv("SDS 322E Project/barry_sanders.csv")
bart_starr <- read_csv("SDS 322E Project/bart_starr.csv")
ben_roethlisberger <- read_csv("SDS 322E Project/ben_roethlisberger.csv")
bob_griese <- read_csv("SDS 322E Project/bob_griese.csv")
bob_lilly <- read_csv("SDS 322E Project/bob_lilly.csv")
bobby_bell <- read_csv("SDS 322E Project/bobby_bell.csv")
bobby_boyd <- read_csv("SDS 322E Project/bobby_boyd.csv")
bobby_wagner <- read_csv("SDS 322E Project/bobby_wagner.csv")
boomer_esiason <- read_csv("SDS 322E Project/boomer_esiason.csv")
brett_favre <- read_csv("SDS 322E Project/brett_favre.csv")
brian_dawkins <- read_csv("SDS 322E Project/brian_dawkins.csv")
brian_urlacher <- read_csv("SDS 322E Project/brian_urlacher.csv")
bruce_matthews <- read_csv("SDS 322E Project/bruce_matthews.csv")
bruce_smith <- read_csv("SDS 322E Project/bruce_smith.csv")
buck_buchanan <- read_csv("SDS 322E Project/buck_buchanan.csv")
calais_campbell <- read_csv("SDS 322E Project/calais_campbell.csv")
cam_newton <- read_csv("SDS 322E Project/cam_newton.csv")
cameron_jordan <- read_csv("SDS 322E Project/cameron_jordan.csv")
carl_eller <- read_csv("SDS 322E Project/carl_eller.csv")
carson_palmer <- read_csv("SDS 322E Project/carson_palmer.csv")
champ_bailey <- read_csv("SDS 322E Project/champ_bailey.csv")
charles_woodson <- read_csv("SDS 322E Project/charles_woodson.csv")
charley_taylor <- read_csv("SDS 322E Project/charley_taylor.csv")
charlie_joiner <- read_csv("SDS 322E Project/charlie_joiner.csv")
chris_doleman <- read_csv("SDS 322E Project/chris_doleman.csv")
chris_hanburger <- read_csv("SDS 322E Project/chris_hanburger.csv")
chuck_howley <- read_csv("SDS 322E Project/chuck_howley.csv")
clay_matthews <- read_csv("SDS 322E Project/clay_matthews.csv")
cornelius_bennett <- read_csv("SDS 322E Project/cornelius_bennett.csv")
cornell_green <- read_csv("SDS 322E Project/cornell_green.csv")
cortez_kennedy <- read_csv("SDS 322E Project/cortez_kennedy.csv")
cris_carter <- read_csv("SDS 322E Project/cris_carter.csv")
curtis_martin <- read_csv("SDS 322E Project/curtis_martin.csv")
dan_fouts <- read_csv("SDS 322E Project/dan_fouts.csv")
dan_hampton <- read_csv("SDS 322E Project/dan_hampton.csv")
dan_marino <- read_csv("SDS 322E Project/dan_marino.csv")
darrell_green <- read_csv("SDS 322E Project/darrell_green.csv")
darrelle_revis <- read_csv("SDS 322E Project/darrelle_revis.csv")
dave_krieg <- read_csv("SDS 322E Project/dave_krieg.csv")
deacon_jones <- read_csv("SDS 322E Project/deacon_jones.csv")
deion_sanders <- read_csv("SDS 322E Project/deion_sanders.csv")
demarcus_ware <- read_csv("SDS 322E Project/demarcus_ware.csv")
dermontti_dawson <- read_csv("SDS 322E Project/dermontti_dawson.csv")
derrick_brooks <- read_csv("SDS 322E Project/derrick_brooks.csv")
derrick_thomas <- read_csv("SDS 322E Project/derrick_thomas.csv")
dick_schafrath <- read_csv("SDS 322E Project/dick_schafrath.csv")
don_maynard <- read_csv("SDS 322E Project/don_maynard.csv")
donnie_shell <- read_csv("SDS 322E Project/donnie_shell.csv")
donovan_mcnabb <- read_csv("SDS 322E Project/donovan_mcnabb.csv")
drew_bledsoe <- read_csv("SDS 322E Project/drew_bledsoe.csv")
drew_brees <- read_csv("SDS 322E Project/drew_brees.csv")
ed_reed <- read_csv("SDS 322E Project/ed_reed.csv")
edgerrin_james <- read_csv("SDS 322E Project/edgerrin_james.csv")
eli_manning <- read_csv("SDS 322E Project/eli_manning.csv")
emmitt_smith <- read_csv("SDS 322E Project/emmitt_smith.csv")
eric_allen <- read_csv("SDS 322E Project/eric_allen.csv")
eric_dickerson <- read_csv("SDS 322E Project/eric_dickerson.csv")
forrest_gregg <- read_csv("SDS 322E Project/forrest_gregg.csv")
fran_tarkenton <- read_csv("SDS 322E Project/fran_tarkenton.csv")
franco_harris <- read_csv("SDS 322E Project/franco_harris.csv")
frank_gore <- read_csv("SDS 322E Project/frank_gore.csv")
gary_zimmerman <- read_csv("SDS 322E Project/gary_zimmerman.csv")
gene_upshaw <- read_csv("SDS 322E Project/gene_upshaw.csv")
george_blanda <- read_csv("SDS 322E Project/george_blanda.csv")
haloti_ngata <- read_csv("SDS 322E Project/haloti_ngata.csv")
hardy_nickerson <- read_csv("SDS 322E Project/hardy_nickerson.csv")
harold_jackson <- read_csv("SDS 322E Project/harold_jackson.csv")
harry_carson <- read_csv("SDS 322E Project/harry_carson.csv")
henry_ellard <- read_csv("SDS 322E Project/henry_ellard.csv")
henry_jordan <- read_csv("SDS 322E Project/henry_jordan.csv")
herb_adderley <- read_csv("SDS 322E Project/herb_adderley.csv")
howie_long <- read_csv("SDS 322E Project/howie_long.csv")
isaac_bruce <- read_csv("SDS 322E Project/isaac_bruce.csv")
isiah_robertson <- read_csv("SDS 322E Project/isiah_robertson.csv")
jack_ham <- read_csv("SDS 322E Project/jack_ham.csv")
jack_lambert <- read_csv("SDS 322E Project/jack_lambert.csv")
jack_youngblood <- read_csv("SDS 322E Project/jack_youngblood.csv")
jahri_evans <- read_csv("SDS 322E Project/jahri_evans.csv")
james_farrior <- read_csv("SDS 322E Project/james_farrior.csv")
james_harrison <- read_csv("SDS 322E Project/james_harrison.csv")
james_lofton <- read_csv("SDS 322E Project/james_lofton.csv")
jared_allen <- read_csv("SDS 322E Project/jared_allen.csv")
jason_peters <- read_csv("SDS 322E Project/jason_peters.csv")
jason_taylor <- read_csv("SDS 322E Project/jason_taylor.csv")
jeff_saturday <- read_csv("SDS 322E Project/jeff_saturday.csv")
jerry_rice <- read_csv("SDS 322E Project/jerry_rice.csv")
jim_brown <- read_csv("SDS 322E Project/jim_brown.csv")
jim_hart <- read_csv("SDS 322E Project/jim_hart.csv")
jim_kelly <- read_csv("SDS 322E Project/jim_kelly.csv")
jim_marshall <- read_csv("SDS 322E Project/jim_marshall.csv")
jim_otto <- read_csv("SDS 322E Project/jim_otto.csv")
jim_tyrer <- read_csv("SDS 322E Project/jim_tyrer.csv")
jimmy_johnson <- read_csv("SDS 322E Project/jimmy_johnson.csv")
jimmy_smith <- read_csv("SDS 322E Project/jimmy_smith.csv")
jj_watt <- read_csv("SDS 322E Project/jj_watt.csv")
joe_flacco <- read_csv("SDS 322E Project/joe_flacco.csv")
joe_greene <- read_csv("SDS 322E Project/joe_greene.csv")
joe_montana <- read_csv("SDS 322E Project/joe_montana.csv")
joe_namath <- read_csv("SDS 322E Project/joe_namath.csv")
john_abraham <- read_csv("SDS 322E Project/john_abraham.csv")
john_brodie <- read_csv("SDS 322E Project/john_brodie.csv")
john_elway <- read_csv("SDS 322E Project/john_elway.csv")
john_hadl <- read_csv("SDS 322E Project/john_hadl.csv")
john_hannah <- read_csv("SDS 322E Project/john_hannah.csv")
john_randle <- read_csv("SDS 322E Project/john_randle.csv")
johnny_robinson <- read_csv("SDS 322E Project/johnny_robinson.csv")
johnny_unitas <- read_csv("SDS 322E Project/johnny_unitas.csv")
jonathan_ogden <- read_csv("SDS 322E Project/jonathan_ogden.csv")
julio_jones <- read_csv("SDS 322E Project/julio_jones.csv")
julius_peppers <- read_csv("SDS 322E Project/julius_peppers.csv")
junior_seau <- read_csv("SDS 322E Project/junior_seau.csv")
justin_smith <- read_csv("SDS 322E Project/justin_smith.csv")
karl_mecklenburg <- read_csv("SDS 322E Project/karl_mecklenburg.csv")
ken_anderson <- read_csv("SDS 322E Project/ken_anderson.csv")
ken_houston <- read_csv("SDS 322E Project/ken_houston.csv")
ken_riley <- read_csv("SDS 322E Project/ken_riley.csv")
ken_stabler <- read_csv("SDS 322E Project/ken_stabler.csv")
kevin_greene <- read_csv("SDS 322E Project/kevin_greene.csv")
kevin_mawae <- read_csv("SDS 322E Project/kevin_mawae.csv")
kevin_williams <- read_csv("SDS 322E Project/kevin_williams.csv")
kurt_warner <- read_csv("SDS 322E Project/kurt_warner.csv")
ladainian_tomlinson <- read_csv("SDS 322E Project/ladainian_tomlinson.csv")
lance_alworth <- read_csv("SDS 322E Project/lance_alworth.csv")
lance_briggs <- read_csv("SDS 322E Project/lance_briggs.csv")
larry_allen <- read_csv("SDS 322E Project/larry_allen.csv")
larry_fitzgerald <- read_csv("SDS 322E Project/larry_fitzgerald.csv")
larry_grantham <- read_csv("SDS 322E Project/larry_grantham.csv")
larry_little <- read_csv("SDS 322E Project/larry_little.csv")
larry_wilson <- read_csv("SDS 322E Project/larry_wilson.csv")
lawrence_taylor <- read_csv("SDS 322E Project/lawrence_taylor.csv")
lem_barney <- read_csv("SDS 322E Project/lem_barney.csv")
lemar_parrish <- read_csv("SDS 322E Project/lemar_parrish.csv")
len_dawson <- read_csv("SDS 322E Project/len_dawson.csv")
logan_mankins <- read_csv("SDS 322E Project/logan_mankins.csv")
lomas_brown <- read_csv("SDS 322E Project/lomas_brown.csv")
london_fletcher <- read_csv("SDS 322E Project/london_fletcher.csv")
luke_kuechly <- read_csv("SDS 322E Project/luke_kuechly.csv")
marcus_allen <- read_csv("SDS 322E Project/marcus_allen.csv")
mark_brunell <- read_csv("SDS 322E Project/mark_brunell.csv")
marshal_yanda <- read_csv("SDS 322E Project/marshal_yanda.csv")
marshall_faulk <- read_csv("SDS 322E Project/marshall_faulk.csv")
marvin_harrison <- read.csv("SDS 322E Project/marvin_harrison.csv")
matt_ryan <- read_csv("SDS 322E Project/matt_ryan.csv")
matthew_stafford <- read_csv("SDS 322E Project/matthew_stafford.csv")
mel_blount <- read_csv("SDS 322E Project/mel_blount.csv")
mel_renfro <- read_csv("SDS 322E Project/mel_renfro.csv")
merlin_olsen <- read_csv("SDS 322E Project/merlin_olsen.csv")
michael_irvin <- read_csv("SDS 322E Project/michael_irvin.csv")
michael_strahan <- read_csv("SDS 322E Project/michael_strahan.csv")
michael_vick <- read_csv("SDS 322E Project/michael_vick.csv")
mick_tingelhoff <- read_csv("SDS 322E Project/mick_tingelhoff.csv")
mike_haynes <- read_csv("SDS 322E Project/mike_haynes.csv")
mike_kenn <- read_csv("SDS 322E Project/mike_kenn.csv")
mike_munchak <- read_csv("SDS 322E Project/mike_munchak.csv")
mike_singletary <- read_csv("SDS 322E Project/mike_singletary.csv")
mike_webster <- read_csv("SDS 322E Project/mike_webster.csv")
ndamukong_suh <- read_csv("SDS 322E Project/ndamukong_suh.csv")
neil_smith <- read_csv("SDS 322E Project/neil_smith.csv")
nick_buoniconti <- read_csv("SDS 322E Project/nick_buoniconti.csv")
oj_simpson <- read_csv("SDS 322E Project/oj_simpson.csv")
orlando_pace <- read_csv("SDS 322E Project/orlando_pace.csv")
pat_swilling <- read_csv("SDS 322E Project/pat_swilling.csv")
patrick_peterson <- read_csv("SDS 322E Project/patrick_peterson.csv")
patrick_willis <- read_csv("SDS 322E Project/patrick_willis.csv")
paul_krause <- read_csv("SDS 322E Project/paul_krause.csv")
paul_warfield <- read_csv("SDS 322E Project/paul_warfield.csv")
peyton_manning <- read_csv("SDS 322E Project/peyton_manning.csv")
phil_simms <- read_csv("SDS 322E Project/phil_simms.csv")
philip_rivers <- read_csv("SDS 322E Project/philip_rivers.csv")
randall_cunningham <- read_csv("SDS 322E Project/randall_cunningham.csv")
randall_mcdaniel <- read_csv("SDS 322E Project/randall_mcdaniel.csv")
randy_moss <- read_csv("SDS 322E Project/randy_moss.csv")
randy_white <- read_csv("SDS 322E Project/randy_white.csv")
ray_lewis <- read_csv("SDS 322E Project/ray_lewis.csv")
ray_nitschke <- read_csv("SDS 322E Project/ray_nitschke.csv")
reggie_wayne <- read_csv("SDS 322E Project/reggie_wayne.csv")
reggie_white <- read_csv("SDS 322E Project/reggie_white.csv")
rich_gannon <- read_csv("SDS 322E Project/rich_gannon.csv")
richard_dent <- read_csv("SDS 322E Project/richard_dent.csv")
richard_seymour <- read_csv("SDS 322E Project/richard_seymour.csv")
richard_sherman <- read_csv("SDS 322E Project/richard_sherman.csv")
richmond_webb <- read_csv("SDS 322E Project/richmond_webb.csv")
rickey_jackson <- read_csv("SDS 322E Project/rickey_jackson.csv")
ricky_watters <- read_csv("SDS 322E Project/ricky_watters.csv")
rod_smith <- read_csv("SDS 322E Project/rod_smith.csv")
rod_woodson <- read_csv("SDS 322E Project/rod_woodson.csv")
roger_craig <- read_csv("SDS 322E Project/roger_craig.csv")
roger_staubach <- read_csv("SDS 322E Project/roger_staubach.csv")
roger_wehrli <- read_csv("SDS 322E Project/roger_wehrli.csv")
roman_gabriel <- read_csv("SDS 322E Project/roman_gabriel.csv")
ron_mcdole <- read_csv("SDS 322E Project/ron_mcdole.csv")
ron_yary <- read_csv("SDS 322E Project/ron_yary.csv")
ronde_barber <- read_csv("SDS 322E Project/ronde_barber.csv")
ronnie_lott <- read_csv("SDS 322E Project/ronnie_lott.csv")
russell_wilson <- read_csv("SDS 322E Project/russell_wilson.csv")
sam_mills <- read_csv("SDS 322E Project/sam_mills.csv")
sonny_jurgensen <- read_csv("SDS 322E Project/sonny_jurgensen.csv")
steve_grogan <- read_csv("SDS 322E Project/steve_grogan.csv")
steve_hutchinson <- read_csv("SDS 322E Project/steve_hutchinson.csv")
steve_largent <- read_csv("SDS 322E Project/steve_largent.csv")
steve_mcmichael <- read_csv("SDS 322E Project/steve_mcmichael.csv")
steve_mcnair <- read_csv("SDS 322E Project/steve_mcnair.csv")
steve_smith_sr <- read_csv("SDS 322E Project/steve_smith_sr.csv")
steve_wisniewski <- read_csv("SDS 322E Project/steve_wisniewski.csv")
steve_young <- read_csv("SDS 322E Project/steve_young.csv")
ted_hendricks <- read_csv("SDS 322E Project/ted_hendricks.csv")
terrell_owens <- read_csv("SDS 322E Project/terrell_owens.csv")
terrell_suggs <- read_csv("SDS 322E Project/terrell_suggs.csv")
terry_bradshaw <- read_csv("SDS 322E Project/terry_bradshaw.csv")
thurman_thomas <- read_csv("SDS 322E Project/thurman_thomas.csv")
tiki_barber <- read_csv("SDS 322E Project/tiki_barber.csv")
tim_brown <- read_csv("SDS 322E Project/tim_brown.csv")
tom_brady <- read_csv("SDS 322E Project/tom_brady.csv")
tom_mack <- read_csv("SDS 322E Project/tom_mack.csv")
tom_nalen <- read_csv("SDS 322E Project/tom_nalen.csv")
tony_dorsett <- read_csv("SDS 322E Project/tony_dorsett.csv")
tony_gonzalez <- read_csv("SDS 322E Project/tony_gonzalez.csv")
tony_romo <- read_csv("SDS 322E Project/tony_romo.csv")
too_tall_jones <- read_csv("SDS 322E Project/too_tall_jones.csv")
torry_holt <- read_csv("SDS 322E Project/torry_holt.csv")
trent_green <- read_csv("SDS 322E Project/trent_green.csv")
troy_aikman <- read_csv("SDS 322E Project/troy_aikman.csv")
troy_polamalu <- read_csv("SDS 322E Project/troy_polamalu.csv")
vinny_testaverde <- read_csv("SDS 322E Project/vinny_testaverde.csv")
von_miller <- read_csv("SDS 322E Project/von_miller.csv")
walter_jones <- read_csv("SDS 322E Project/walter_jones.csv")
walter_payton <- read_csv("SDS 322E Project/walter_payton.csv")
warren_moon <- read_csv("SDS 322E Project/warren_moon.csv")
warren_sapp <- read_csv("SDS 322E Project/warren_sapp.csv")
warrick_dunn <- read_csv("SDS 322E Project/warrick_dunn.csv")
wayne_walker <- read_csv("SDS 322E Project/wayne_walker.csv")
wes_welker <- read_csv("SDS 322E Project/wes_welker.csv")
wilber_marshall <- read_csv("SDS 322E Project/wilber_marshall.csv")
will_shields <- read_csv("SDS 322E Project/will_shields.csv")
willie_anderson <- read_csv("SDS 322E Project/willie_anderson.csv")
willie_brown <- read_csv("SDS 322E Project/willie_brown.csv")
willie_davis <- read_csv("SDS 322E Project/willie_davis.csv")
willie_roaf <- read_csv("SDS 322E Project/willie_roaf.csv")
willie_wood <- read_csv("SDS 322E Project/willie_wood.csv")
zach_thomas <- read_csv("SDS 322E Project/zach_thomas.csv")
```
